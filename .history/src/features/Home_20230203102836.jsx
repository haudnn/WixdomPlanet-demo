    ...
    <section className='home py-10 max-w-[1140px] my-0 mx-auto'>
        ...
        <div className='mt-10 flex items-center justify-between'>
            ...
            <div className='w-[280px]'>
                <input type="text" placeholder='Enter name event' className='text-sm pl-[30px] pr-[15px] h-10 leading-10 border border-solid border-[#636366] inline-block w-full bg-[#3a3a3c] rounded-lg focus:border-[#636366]'/>
            </div>
        </div>
    </section>
  )
