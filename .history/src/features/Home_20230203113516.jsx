    ...
    <section className="home py-10 max-w-[1140px] my-0 mx-auto">
      ...
      <div className="mt-10 flex items-center justify-between">
        <ul className="flex items-center gap-x-10">
          <li className="bg-[#f5f5f5] rounded-[100px]  text-[#525252] px-3 py-[6px] cursor-pointer text-sm">
            All
          </li>
          <li className="bg-[#f5f5f5] rounded-[100px] font-bold text-[#525252] px-3 py-[6px] cursor-pointer text-sm">
            Active
          </li>
          <li className="bg-[#f5f5f5] rounded-[100px] font-bold text-[#525252] px-3 py-[6px] cursor-pointer text-sm">
            Not Started
