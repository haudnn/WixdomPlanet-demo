            ...
            <Link to="/" className="block rounded-xl p-[2px] cursor-pointer bg-[#2c2c2e] relative h-full">
                <div className="rounded-xl p-3 bg-[#2c2c2e] h-full flex flex-col">
                   ...
                   <div className="flex items-center box-border">
                        <span style={{display:"-webkit-box", "-webkit-line-clamp" : "2"}} className="text-white text-xl mt-3 mb-4 font-medium flex-1 max-w-full overflow-hidden text-ellipsis ">Polygon is expanding the ecosytem to Vietnam Polygon is expanding the ecosytem to Vietnam</span>
