            ...
            <Link to="/" className="block rounded-xl p-[2px] cursor-pointer bg-[#2c2c2e] relative h-full">
                <div className="rounded-xl p-3 bg-[#2c2c2e] h-full flex flex-col">
                   ...
                   <div className="flex items-center justify-between my-3 ">
                        <span className="text-white text-xl flex-1 max-w-full overflow-hidden text-ellipsis break-words ">Bring your own furry pet by the use of 3d scanning technology</span>
